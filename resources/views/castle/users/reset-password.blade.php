<x-app.auth :title="__('Reset User\'s Password')">
    <div>
        <div class="max-w-6xl mx-auto py-5 sm:px-6 lg:px-8">
            <x-link :href="route('castle.users.edit', $user->id)" color="gray" class="inline-flex items-center border-b-2 border-green-base hover:border-green-500 text-sm font-medium leading-5">
            ...
            <x-form :route="route('castle.users.reset-password', $user->id)" put>
                ...
                <div class="mt-8 pt-2 flex justify-end">
                    ...
                    <span class="ml-3 inline-flex rounded-md shadow-sm">
                        <a href="{{route('castle.users.edit', $user->id)}}" class="py-2 px-4 border border-transparent text-sm leading-5 font-medium rounded-md text-gray-800 hover:bg-gray-300 focus:outline-none focus:border-gray-300 focus:shadow-outline-gray transition duration-150 ease-in-out">
                            Cancel
                        </a>
                    </span>
                </div>
