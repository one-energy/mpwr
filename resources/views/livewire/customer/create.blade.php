                    ...
                    <div class="sm:grid sm:grid-cols-2 sm:row-gap-6 sm:col-gap-4 mt-6 md:grid-cols-6">
                        ...
                        <div class="col-span-2 md:col-span-3">
                            <x-input wire:model="customer.last_name" label="Customer Last Name"
                                     name="customer.last_name" :wire="true"/>
                        </div>

                        <div class="col-span-1 md:col-span-2">
                            <x-input-add-on wire:model="customer.system_size" label="System Size" name="customer.system_size"
                                            addOn="kW" :wire="true"/>
                        </div>

                        <div class="col-span-1">
                            <x-select label="Bill" name="customer.bill" :wire="true">
                                @if (old('bill') == '')
                        ...
                        <div class="col-span-2 md:col-span-3">
                            <x-input wire:model="customer.adders" label="Adders Total" name="customer.adders" step="0.01"
                                     type="number" :wire="true"/>
                        </div>

                        <div class="col-span-1 md:col-span-2">
                            <x-input-currency wire:model="customer.epc" label="EPC" name="customer.epc"
                                              observation="Sold Price" :wire="true"/>
                        </div>
