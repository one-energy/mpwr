    ...
    <div>
        <div class="max-w-6xl py-5 mx-auto sm:px-6 lg:px-8">
            <x-link :href="route('home')" color="gray"
                    class="inline-flex items-center text-sm font-medium leading-5 border-b-2 border-green-base hover:border-green-500">
            ...
            <form wire:submit.prevent="store">
                ...
                <div>
                    ...
                    <div class="sm:grid sm:grid-cols-2 sm:row-gap-6 sm:col-gap-4 mt-6 md:grid-cols-6">
                        ...
                        <div class="col-span-2 md:col-span-3">
                            <x-input wire:model="customer.adders" label="Adders Total" name="adders" step="0.01"
                                     type="number"/>
                        </div>

                        <div class="col-span-1 md:col-span-2">
                            <x-input-currency wire:model="customer.epc" label="EPC" name="epc"
                            ...
                            <div class="w-full col-span-1 md:col-span-2">
                                <x-select wire:model="customer.term_id" label="Term" name="term_id" readonly>
                                    ...
                                    @foreach($terms as $term)
                                        <option
                                            value="{{ $term->id }}" {{ old('term_id') == $term->id ? 'selected' : '' }}>
                                            {{ $term->value }}
                                        </option>
                                    @endforeach
                                </x-select>
                        ...
                        <div class="col-span-2 md:col-span-3">
                            <x-input-currency wire:model="customer.setter_fee" label="Setter Fee" name="setter_fee"
                                              value="{{$setterFee}}" readonly/>
                        </div>

                        <div class="col-span-2 md:col-span-3">
                            <x-select wire:change="getSalesRepRate($event.target.value)"
                                      wire:model="customer.sales_rep_id" label="Sales Rep" name="sales_rep_id">
                                <option value="">None</option>
                ...
                <div class="pt-5 mt-8 border-t border-gray-200">
                    <div class="flex justify-start">
                        <span class="inline-flex rounded-md shadow-sm">
                            <button type="submit"
                                    class="inline-flex justify-center px-4 py-2 text-sm font-medium leading-5 text-white transition duration-150 ease-in-out bg-gray-900 border border-transparent rounded-md hover:bg-gray-800 focus:outline-none focus:border-gray-700 focus:shadow-outline-gray">
                                Submit
                            </button>
                        </span>
                        <span class="inline-flex ml-3 rounded-md shadow-sm">
                            <a href="{{route('home')}}"
                               class="px-4 py-2 text-sm font-medium leading-5 text-gray-800 transition duration-150 ease-in-out border border-transparent rounded-md hover:bg-gray-300 focus:outline-none focus:border-gray-300 focus:shadow-outline-gray">
                                Cancel
                            </a>
                        </span>
                    </div>
