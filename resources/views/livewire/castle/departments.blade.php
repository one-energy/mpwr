            ...
            <div class="mt-6">
                <div class="flex flex-col">
                    ...
                    <x-modal x-cloak :title="__('Delete Department')"
                        ...
                        <x-form :route="route('castle.departments.destroy', $deletingDepartment->id ?? 0)" delete class="w-full p-2">
                            @if($deletingDepartment && (count($deletingDepartment->regions) || count($deletingDepartment->users)))
                                <x-input class="pb-2" label="Department Name" name="confirmDelete"/>
                            @endif
