...
class ScoreboardController extends Controller
{
    public function __invoke(Request $request)
    {
        ...
        $top10Hours = User::query()
            ...
            ->select(DB::raw('sum(daily_numbers.hours) as hours, users.office, users.first_name, users.last_name'))
            ->groupBy('users.id')
        ...
        $top10Sets = User::query()
            ...
            ->select(DB::raw('sum(daily_numbers.sets) as sets, users.office, users.first_name, users.last_name'))
            ->groupBy('users.id')
        ...
        $top10SetCloses = User::query()
            ...
            ->select(DB::raw('sum(daily_numbers.set_closes) as set_closes, users.office, users.first_name, users.last_name'))
            ->groupBy('users.id')
